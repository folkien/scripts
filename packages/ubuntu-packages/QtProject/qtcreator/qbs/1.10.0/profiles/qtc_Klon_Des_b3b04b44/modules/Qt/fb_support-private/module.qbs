...
QtModule {
    ...
    libFilePathDebug: ""
    libFilePathRelease: "/opt/Qt5.9.4-i386/lib/libQt5FbSupport.a"
    cpp.defines: ["QT_FB_SUPPORT_LIB"]
    cpp.includePaths: ["/opt/Qt5.9.4-i386/include", "/opt/Qt5.9.4-i386/include/QtFbSupport", "/opt/Qt5.9.4-i386/include/QtFbSupport/5.9.4", "/opt/Qt5.9.4-i386/include/QtFbSupport/5.9.4/QtFbSupport"]
