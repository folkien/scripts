...
QtModule {
    ...
    libFilePathDebug: ""
    libFilePathRelease: "/opt/Qt5.9.4-i386/lib/libQt5AccessibilitySupport.a"
    cpp.defines: ["QT_ACCESSIBILITY_SUPPORT_LIB"]
    cpp.includePaths: ["/opt/Qt5.9.4-i386/include", "/opt/Qt5.9.4-i386/include/QtAccessibilitySupport", "/opt/Qt5.9.4-i386/include/QtAccessibilitySupport/5.9.4", "/opt/Qt5.9.4-i386/include/QtAccessibilitySupport/5.9.4/QtAccessibilitySupport"]
