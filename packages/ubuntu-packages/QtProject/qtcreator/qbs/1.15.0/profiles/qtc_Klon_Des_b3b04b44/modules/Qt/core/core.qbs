...
Module {
    ...
    property path binPath: "/opt/Qt5.9.4-i386/bin"
    property path incPath: "/opt/Qt5.9.4-i386/include"
    property path libPath: "/opt/Qt5.9.4-i386/lib"
    property path pluginPath: "/opt/Qt5.9.4-i386/plugins"
    property string mkspecName: "linux-g++-32"
    property path mkspecPath: "/opt/Qt5.9.4-i386/mkspecs/linux-g++-32"
    ...
    property path docPath: "/opt/Qt5.9.4-i386/doc"
    ...
    property string libFilePathRelease: "/opt/Qt5.9.4-i386/lib/libQt5Core.so.5.9.4"
    ...
    cpp.includePaths: {
        var paths = ["/opt/Qt5.9.4-i386/include", "/opt/Qt5.9.4-i386/include/QtCore"];
