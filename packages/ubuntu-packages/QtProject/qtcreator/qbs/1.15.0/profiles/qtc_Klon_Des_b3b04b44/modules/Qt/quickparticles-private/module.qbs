...
QtModule {
    ...
    libFilePathDebug: ""
    libFilePathRelease: "/opt/Qt5.9.4-i386/lib/libQt5QuickParticles.so.5.9.4"
    cpp.defines: ["QT_QUICKPARTICLES_LIB"]
    cpp.includePaths: ["/opt/Qt5.9.4-i386/include", "/opt/Qt5.9.4-i386/include/QtQuickParticles", "/opt/Qt5.9.4-i386/include/QtQuickParticles/5.9.4", "/opt/Qt5.9.4-i386/include/QtQuickParticles/5.9.4/QtQuickParticles"]
