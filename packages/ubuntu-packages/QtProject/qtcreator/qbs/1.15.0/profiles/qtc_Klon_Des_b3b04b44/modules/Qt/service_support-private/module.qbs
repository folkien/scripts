...
QtModule {
    ...
    libFilePathDebug: ""
    libFilePathRelease: "/opt/Qt5.9.4-i386/lib/libQt5ServiceSupport.a"
    cpp.defines: ["QT_SERVICE_SUPPORT_LIB"]
    cpp.includePaths: ["/opt/Qt5.9.4-i386/include", "/opt/Qt5.9.4-i386/include/QtServiceSupport", "/opt/Qt5.9.4-i386/include/QtServiceSupport/5.9.4", "/opt/Qt5.9.4-i386/include/QtServiceSupport/5.9.4/QtServiceSupport"]
