...
do
    ...
    sshpass -p "${password}" ssh -tt -v -o PreferredAuthentications=password -o PubkeyAuthentication=no -o BatchMode=yes -o ConnectTimeout=10 -oStrictHostKeyChecking=no ${login}@${ipHost}
done
